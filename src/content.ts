        ...
        },
        {
          ...
          caseStudy: {
            ...
            requestFlow: [
              ...
              { name: 'Processamento', description: 'Transcreve áudio quando necessário, recupera o contexto da conversa e prepara a entrada do agente.',},
              { name: 'Agente de IA', description: 'Classifica a intenção do utilizador e coordena a geração da resposta.',},
              { name: 'OpenAI', description: 'Gera texto ou conteúdo estruturado conforme o tipo de solicitação.',},
              { name: 'Integrações', description: 'Envia a resposta ao Telegram ou publica automaticamente texto e imagem no LinkedIn.',},
            ],
            ...
            skills: ['Backend Engineering', 'Cloud Engineering (AWS)', 'Arquitetura Serverless', 'Integração de APIs', 'CI/CD e Testes Automatizados', 'LLM Integration'],
          },
        },
        {
