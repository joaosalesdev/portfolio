  ...
  pt: {
    ...
    projects: {
      ...
      caseStudy: {
        ...
        productionImpact: 'Impacto em produção',
        results: 'Resultado',
      ...
      items: [
        ...
        },
        {
          ...
          caseStudy: {
            ...
            productionImpact: [
              'Utilizado diariamente como assistente pessoal para criação de conteúdo técnico.',
              'Aproximadamente cinco meses de utilização contínua em ambiente real.',
              'Automatiza desde a interpretação da solicitação até a publicação no LinkedIn.',
              'Reduziu significativamente o tempo necessário para produzir publicações técnicas.',
              'Mantém baixo custo operacional, com aproximadamente US$ 0,05/mês em serviços AWS utilizados pela solução.',
              'Arquitetura serverless permitindo operação praticamente sem manutenção de infraestrutura.',
            ],
      ...
      items: [
        ...
        },
        {
          ...
          caseStudy: {
            ...
            productionImpact: [
              'Used daily as a personal assistant for creating technical content.',
              'Approximately five months of continuous use in a real-world environment.',
              'Automates the entire workflow, from interpreting the request to publishing on LinkedIn.',
              'Significantly reduced the time required to produce technical posts.',
              'Maintains a low operating cost of approximately US$0.05 per month for the AWS services used by the solution.',
              'Serverless architecture enables operation with virtually no infrastructure maintenance.',
            ],
