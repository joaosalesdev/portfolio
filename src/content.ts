        ...
        },
        {
          ...
          caseStudy: {
            ...
            requestFlow: [
              ...
              { name: 'Output Validation', description: 'Verifica a resposta antes de a disponibilizar ao utilizador.' },
              { name: 'Client', description: 'Recebe a resposta validada e atualiza o histórico da conversa.' },
            ],
            ...
            resultBenefits: ['Respostas mais contextualizadas', 'Comportamento mais previsível', 'Execução serverless escalável', 'Base preparada para testes e evolução'],
            skills: ['Engenharia de prompts', 'Agentes de IA', 'Arquitetura de contexto', 'LLM Integration', 'Serverless Architecture', 'Avaliação de IA'],
          },
        },
        {
        ...
        },
        {
          ...
          caseStudy: {
            ...
            requestFlow: [
              ...
              { name: 'Output Validation', description: 'Checks the response before making it available to the user.' },
              { name: 'Client', description: 'Receives the validated response and updates the conversation history.' },
            ],
            ...
            resultBenefits: ['More contextual responses', 'More predictable behavior', 'Scalable serverless execution', 'Foundation for testing and evolution'],
            skills: ['Prompt engineering', 'AI agents', 'Context architecture', 'LLM Integration', 'Serverless Architecture', 'AI Evaluation'],
          },
        },
        {
          slug: 'process-automation-platform',
