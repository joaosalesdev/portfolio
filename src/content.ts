      ...
      items: [
        {
          ...
          caseStudy: {
            ...
            productionImpact: [
              'Executa a integração entre Salesforce e serviços externos em ambiente de produção.',
              'Reduz atividades manuais no processo de sincronização das informações comerciais.',
              'Aumenta a consistência dos dados compartilhados entre sistemas independentes.',
              'Utiliza processamento assíncrono para desacoplar os sistemas e absorver variações de carga.',
              'Garante reprocessamentos seguros por meio de identificação externa e idempotência.',
              'Mantém contexto de execução para facilitar rastreabilidade, auditoria e diagnóstico de falhas.',
            ],
      ...
      items: [
        {
          ...
          caseStudy: {
            ...
            productionImpact: [
              'Runs the integration between Salesforce and external services in a production environment.',
              'Reduces manual work in the commercial information synchronization process.',
              'Improves the consistency of data shared between independent systems.',
              'Uses asynchronous processing to decouple systems and absorb workload variations.',
              'Ensures safe reprocessing through external identifiers and idempotency.',
              'Preserves execution context to support traceability, auditing, and failure diagnosis.',
            ],
